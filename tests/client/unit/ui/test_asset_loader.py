...
from client.ui.assets.asset_loader import AssetLoader, PieceAsset
...
def test_asset_loader_pieces_initialization():
    ...
    assert loader.base_dir == pathlib.Path(__file__).parent.parent.parent.parent.parent / "client" / "ui"
